...
describe(`Updates article`, () => {
  ...
  test(`Prop "createdDate" should be 2020-11-13T23:37:29.521Z`, async () => {
    expect(response.body.createdDate).toBe(`2020-11-13T23:37:29.521Z`);
  });
});
...
describe(`Can't update article, because not all props provided`, () => {
  ...
  beforeAll(async () => {
    response = await request(app)
      .put(`/api/articles/3jKViUtz9mODTX_24Krpa`)
      .send({"createdDate": `2020-11-13T23:37:29.521Z`});
  });
